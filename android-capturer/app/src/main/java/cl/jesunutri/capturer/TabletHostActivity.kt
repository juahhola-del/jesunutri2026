...
class TabletHostActivity : ComponentActivity() {
    ...
    private fun buildUi() {
        ...
        importButton = smallButton("Importar Supabase") { importSupabase() }
    ...
    private suspend fun refreshStatus() {
        ...
        setupPanel.visibility = if (installed && imported) View.GONE else View.VISIBLE
        installButton.visibility = if (installed) View.GONE else View.VISIBLE
        importButton.visibility = if (installed) View.VISIBLE else View.GONE
    }
    ...
    companion object {
        private const val APP_URL = "https://jesunutri2026.vercel.app"

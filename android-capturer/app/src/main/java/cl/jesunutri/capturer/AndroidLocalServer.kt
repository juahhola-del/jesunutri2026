    ...
    override fun serve(session: IHTTPSession): Response {
        ...
        return try {
            ...
            val response = when {
                ...
                method == Method.POST && path == "/api/backup" -> json(JSONObject().put("ok", true).put("status", "omitido").put("message", "Backup Android pendiente de empaquetar. La base oficial queda en almacenamiento privado de la app."))
